...
?>
    ...
    <div class="large-4 medium-4 columns"> <img class="footer-logo" src="https://www.lorainccc.edu/stocker/wp-content/uploads/sites/69/2016/07/Stocker-Arts-Ctr-logo.svg" alt="LCCC Stocker Footer Logo" width="260" height="82.5"/>
      ...
      <ul class="menu footer-sm-links">
        ...
        <li><a href="https://twitter.com/StockerArts" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/icons/twitter_white.svg" height="30" width="30" alt="" /></a></li>
       
      </ul>
      <a href="https://www.lorainccc.edu/campus-technology/lccc-mobile/" target="_blank" class="clearfix mobile-app-link"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/icons/smartphone_yellow.svg" heigth="33" width="20" alt=""/>
      <h2>LCCC'S<br />
        Mobile App</h2>
      </a> </div>
    <div class="large-4 medium-4 columns">
      ...
      <ul class="underline">
        <li><a href="https://www.lorainccc.edu/stocker/about-the-stocker-arts-center/map-and-directions-to-the-stocker-arts-center/">Map and Directions</a></li>
      </ul>
    </div>
    <div class="large-4 medium-4 columns">
      <h2>Quick Links</h2>
