...
<div id="page" class="hfeed site">
    ...
    <div class="large-6 medium-6 columns"><a href="<?php echo esc_url( home_url( '' ) ); ?>"><img src="https://www.lorainccc.edu/stocker/wp-content/uploads/sites/69/2016/07/Stocker-Arts-Ctr-header-logo.png" height="80" width="340" alt="Stocker Arts Center of Lorain County Community College" /></a>  </div>
...
<div class="medium-blue-bg show-for-medium">
  ...
  <div class="row show-for-small-only mobile-nav-bar">
    ...
    <div class="small-2 columns clearfix"> <span data-responsive-toggle="mobile-search" data-hide-for="medium"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/icons/magnifying-glass.svg" height="25" width="25" alt="Toggle LCCC Stocker Arts Center Search" class="float-right" data-toggle/></span> </div>
